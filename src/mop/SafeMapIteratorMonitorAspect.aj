...
class SafeMapIteratorMonitor extends javamoprt.MOPMonitor implements Cloneable, javamoprt.MOPObject {
	...
	public final void Prop_1_handler_violation (Map map, Collection c, Iterator i){
		{
...
public aspect SafeMapIteratorMonitorAspect implements javamoprt.MOPObject {
	...
	static javamoprt.map.MOPAbstractMap SafeMapIterator_map_i_Map = new javamoprt.map.MOPMapOfAll(0);
	static javamoprt.ref.MOPTagWeakReference SafeMapIterator_map_i_Map_cachekey_0 = javamoprt.map.MOPTagRefMap.NULRef;
	static javamoprt.ref.MOPTagWeakReference SafeMapIterator_map_i_Map_cachekey_2 = javamoprt.map.MOPTagRefMap.NULRef;
	...
	static javamoprt.map.MOPAbstractMap SafeMapIterator_c__To__c_i_Map = new javamoprt.map.MOPMapOfSetMon(1);
	...
	after (Map map) returning (Collection c) : SafeMapIterator_createColl(map) {
		...
		if (mainSet == null || mainMonitor == null) {
			...
			if (mainMonitor == null) {
				origMap = SafeMapIterator_c__To__c_i_Map;
				...
				if (origSet!= null) {
					...
					for(int i_1 = 0; i_1 < origSet.size; i_1++) {
						...
						Iterator i = (Iterator)origMonitor.MOPRef_i.get();
						if (!origMonitor.MOP_terminated && i != null) {
							origSet.elementData[numAlive] = origMonitor;
							numAlive++;

							TempRef_i = origMonitor.MOPRef_i;
							...
							if (lastMonitor == null) {
								...
								if (TempRef_map.disable > origMonitor.tau|| (TempRef_map.tau > 0 && TempRef_map.tau < origMonitor.tau)) {
									timeCheck = false;
								}

								if (timeCheck) {
									lastMonitor = (SafeMapIteratorMonitor)origMonitor.clone();
									lastMonitor.MOPRef_map = TempRef_map;
									...
									tempMap = SafeMapIterator_map_i_Map;
									obj = tempMap.getMap(TempRef_map);
									if (obj == null) {
									...
									obj = mainMap.getMap(TempRef_map);
									if (obj == null) {
										obj = new javamoprt.map.MOPMapOfSetMon(0);
										mainMap.putMap(TempRef_map, obj);
									}
									mainMap = (javamoprt.map.MOPAbstractMap)obj;
									obj = mainMap.getSet(TempRef_c);
				...
				if (mainMonitor == null) {
					origMap = SafeMapIterator_map_c_i_Map;
					origMonitor = (SafeMapIteratorMonitor)origMap.getNode(TempRef_map);
					if (origMonitor != null) {
						boolean timeCheck = true;
				...
				TempRef_map.disable = SafeMapIterator_timestamp;
				TempRef_c.disable = SafeMapIterator_timestamp;
				SafeMapIterator_timestamp++;
			}
		...
		if (mainSet == null || mainMonitor == null) {
			...
			if (mainMonitor == null) {
					...
					for(int i_1 = 0; i_1 < origSet.size; i_1++) {
						...
						if (!origMonitor.MOP_terminated && map != null) {
							...
							if (lastMonitor == null) {
								...
								if (TempRef_c.disable > origMonitor.tau|| (TempRef_c.tau > 0 && TempRef_c.tau < origMonitor.tau)) {
									timeCheck = false;
								}
								if (TempRef_i.disable > origMonitor.tau|| (TempRef_i.tau > 0 && TempRef_i.tau < origMonitor.tau)) {
									timeCheck = false;
								...
								if (timeCheck) {
									lastMonitor = (SafeMapIteratorMonitor)origMonitor.clone();
									lastMonitor.MOPRef_c = TempRef_c;
									if (TempRef_c.tau == -1){
										TempRef_c.tau = origMonitor.tau;
									}
									lastMonitor.MOPRef_i = TempRef_i;
				...
				if (mainMonitor == null) {
					...
					tempMap = SafeMapIterator_c__To__c_i_Map;
					obj = tempMap.getSet(TempRef_c);
					monitors = (SafeMapIteratorMonitor_Set)obj;
					if (monitors == null) {
						monitors = new SafeMapIteratorMonitor_Set();
			...
			if (mainMonitor == null) {
				...
				if (origSet!= null) {
					...
					for(int i_1 = 0; i_1 < origSet.size; i_1++) {
						...
						if (!origMonitor.MOP_terminated && map != null && c != null) {
							origSet.elementData[numAlive] = origMonitor;
							numAlive++;
			...
			if (mainMonitor == null) {
				...
				if (origSet!= null) {
					...
					for(int i_1 = 0; i_1 < origSet.size; i_1++) {
						...
						Collection c = (Collection)origMonitor.MOPRef_c.get();
						Iterator i = (Iterator)origMonitor.MOPRef_i.get();
						if (!origMonitor.MOP_terminated && c != null && i != null) {
							origSet.elementData[numAlive] = origMonitor;
							numAlive++;
							...
							if (lastMonitor == null) {
								...
								if (timeCheck) {
									...
									mainMap = SafeMapIterator_map_c_i_Map;
									obj = mainMap.getSet(TempRef_map);
									mainSet = (SafeMapIteratorMonitor_Set)obj;
									if (mainSet == null) {
										mainSet = new SafeMapIteratorMonitor_Set();
										mainMap.putSet(TempRef_map, mainSet);
